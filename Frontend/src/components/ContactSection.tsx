  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-4 text-cyan-400">{t('Contact AutoRent')}</h2>
          <p className="text-gray-300 text-center mb-8">
            {t('Reach out to our team for booking help, VIP service requests, or any questions about our fleet.')}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-black/50 border border-cyan-500/20 rounded-3xl p-6">
              <h3 className="text-xl font-semibold text-cyan-300 mb-3">{t('Email')}</h3>
              <a href={`mailto:${contact.email}`} className="text-gray-300 hover:text-cyan-300 transition-colors">
                {contact.email}
              </a>
            </div>
            <div className="bg-black/50 border border-cyan-500/20 rounded-3xl p-6">
              <h3 className="text-xl font-semibold text-cyan-300 mb-3">{t('Phone')}</h3>
